...
/* =========================
   ...
   - Parameters ---> local variables to function (placeholder)
*/
...
/* =========================
   ...
   - async/await ---> return a Promise ---> fetch data before you run your code
*/
/*
async function fetchData(params) {
   // fetching data from your servers
...
// syntax: array.map(callback(currentValue))
// Because we are making a new array, it must be placed inside of a new variable
...
// Used for sums, totals, aggreggations
// syntax: array.reduce(callBack(accumulator, currentValue), 0)
// Parameters of reduce are the function and initial value of the accumulator
// Value is saved in new variable
