...
let baseShipping = 9.99
  if (userAge >= 21) {
    ...
    if (cartValue >= 300 || points >= 500) {
      baseShipping = 0
      return 0, console.log(baseShipping);
    } else {
      return baseShipping, console.log(baseShipping);
    }
  } else {
    return "You must be over 21 to use this app", console.log("You must be over 21 to use this app");
  }
