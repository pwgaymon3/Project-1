...
/*
Programming concept that organizes code into objects-collections of data(properties) and functions(methods)
  Allows us to give our set of code behavior

4 Pillars of OOP
1. Encapsulation --> Group your code --> Protects data from direct modification
2. Abstraction --> Hidden --> Only showing what is necessary and hiding complexity
3. Inheritance --> Allows to extend code to child classes--> Allows for one class to extend to another and reuse its properties and methods
...
*/
class CarV4 {
  #miles = 0;                       // private field (encapsulated) - hashtag makes it private
  constructor(brand, model) {
    this.brand = brand;
    this.model = model;
  }
...
- extends says class is child of x
- supr() inherits properties of parent constructor 
*/
class CarBase {
  constructor(brand, model) {
    this.brand = brand;
...
// ev.start(); ev.charge(10); console.log(ev.battery); // 90
